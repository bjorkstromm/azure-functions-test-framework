...
- **Function metadata discovery** via `IFunctionInvoker.GetFunctions()` — returns `IReadOnlyDictionary<string, FunctionMetadata>` with name, function ID, entry point, script file, and parsed bindings
